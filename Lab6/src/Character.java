public class Character {
    ...
    public static class Warrior extends Character {        // base status of warrior
         ...
         * @return : none
         * */
        protected void LevelUp_ofWarrior(){ //when character levelup all status ,Wiill up eg MaxHp ,MaxMana and level can't more than maxlevel
            Level_ofWarrior++;
            createstatus();
        }
    ...
    public  static class Arches extends Character {        // base status of arches
         ...
         * */
        protected void LevelUp_ofArches(){ //when character levelup all status ,Wiill up eg MaxHp ,MaxMana and level can't more than maxlevel
            Level_ofArches++;
            createstatus_ofArches();
        }
